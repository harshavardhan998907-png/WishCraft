...
import { Sparkles, Layout, Heart, Music, Share, ShieldCheck } from 'lucide-react'
...
export function AboutDialog({ open, onClose }: AboutDialogProps) {
  return (
    ...
    >
      <div className="p-1 sm:p-2 space-y-16 sm:space-y-24">
        ...
        <section className="text-center space-y-6 pt-4 sm:pt-8 max-w-2xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-black tracking-tight">
            About WishCraft
          </h2>
