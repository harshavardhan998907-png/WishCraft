...
export function CreatorLayout() {
  ...
  return (
    <section className="min-h-screen bg-zinc-50 dark:bg-[#0f0f17]">
      <div className="border-b border-black/10 bg-white px-4 py-4 dark:border-white/10 dark:bg-[#10101a]">
            ...
            <nav className="grid gap-1">
              {links.map((link) => (
                <NavLink
                  ...
                  className={({ isActive }) => `rounded-md px-3 py-2 text-sm font-black transition ${
                    isActive
