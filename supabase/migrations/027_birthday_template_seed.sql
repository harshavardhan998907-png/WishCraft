-- Migration 027: Seed Birthday Letter In Light Template
-- Set up template in the public.templates table
...
values (
  'b18d2d8e-1718-4cda-92ee-10b27bcfb99b', -- fixed UUID
  'Birthday Letter In Light',
  'birthday-letter-in-light',
  'birthday'::public.occasion_type,
  'premium'::public.template_tier,
  0,
  '/templates/birthday-letter-in-light/thumbnail.png',
  true,
  true,
  'BirthdayLetterInLight',
  'BirthdayLetterInLight',
  ...
  true,
  'published'::public.template_status,
  '{
